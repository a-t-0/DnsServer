...
So for example **suppose you bought www.google.com and you have made a beautifull website (on your pc) that you want to show when people visit google.com**
 ...
 4. Click on `Add Zone`
	![1](./Old_manual_instructions/4.png)
 5. and enter `google.com`
 
	![1](./Old_manual_instructions/5.png)
 6. Then click on "Add record", 
	![1](./Old_manual_instructions/6.png)
...
![1](./Old_manual_instructions/Final_dns_settings.png)
...
![1](./Old_manual_instructions/21.png)
...
![1](./Old_manual_instructions/22.png)
...
![1](./Old_manual_instructions/registrar.png)
...
![1](./Old_manual_instructions/registrar2.png)
...
![1](./Old_manual_instructions/registrar3.png)
